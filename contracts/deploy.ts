...
async function deploy() {
  ...
  try {
    ...
    console.log("📋 Step 1/4: Deploying BantahPoints.sol...");
    ...
    console.log("📋 Step 3/4: Deploying PointsEscrow.sol...");
    ...
    console.log(`✅ PointsEscrow deployed: ${escrowAddress}\n`);

    // Step 4: Setup permissions
    console.log("📋 Step 4/4: Setting up permissions...");
